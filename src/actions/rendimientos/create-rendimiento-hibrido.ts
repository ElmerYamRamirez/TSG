...
export const createRendimientoHibrido = async (item: RendimientoHibrido) => {
    try {
        ...
        Porcentaje_Inicial_T4, Porcentaje_Inicial_TG, Porcentaje_Final_T1, Porcentaje_Final_T2, Porcentaje_Final_T3, Porcentaje_Final_T4, Porcentaje_Final_TG, programacion)
        VALUES (
