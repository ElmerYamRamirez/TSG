...
import React from "react";
  ...
  export default async function ReporteRendimientos({ searchParams }: { searchParams: Promise<{ page?: string; search?: string }> }) {
  ...
  const response = searchTerm
    ? await getReportesRendimientoFiltro(page, pageSize, searchTerm)
    : (await getReportesRendimientoPagination(page, pageSize)) ?? { ok: false, rendimientos: [] };
      ...
      <div className="flex justify-center mb-4">
        <form className="w-full max-w-xl flex flex-wrap gap-2" method="GET">
          <input
            ...
            placeholder="Buscar por unidad o fecha..."
